    ...
    return (
        <div className="flex flex-col items-center text-center mt-20 md:mt-30 pb-20">
            ...
            <p className="w-3/5 mb-14 text-gray-500 text-[15px]">
                Experience the Difference with Easy Booking
                Discover a new standard in hotel booking. Easy Booking is built on the principles of simplicity, reliability, and unparalleled customer service. Let us guide you to your next perfect stay.
            </p>
            <div className="flex flex-wrap gap-6 items-start justify-center">
                <div className="group flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
                    ...
                    <p className="text-center text-gray-500/80 group-hover:text-white/60 w-3/4 mt-4">
                        ...
                        With over 10 years of experience in the travel and hospitality industry, Easy Booking brings a wealth of knowledge and expertise to your hotel booking journey. We&#39;ve spent a decade understanding what travelers need and what makes a truly exceptional stay.
                    </p>
                </div>
                ...
                <div className="group flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
                    ...
                    <p className="text-center text-gray-500/80 group-hover:text-white/60 w-3/4 mt-4">
                        At Easy Booking, your peace of mind is paramount. We understand that booking travel online requires trust, and we&#39;ve built our platform around earning and maintaining yours. We achieve this through, customers trustness.
                    </p>
                </div>
                ...
                <div className="group flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 rounded-md cursor-pointer hover:border-blue-600 hover:bg-blue-600 transition">
                    ...
                    <p className="text-gray-500 group-hover:text-white/80">Unbeatable Prices, Right Here in Easy Booking</p>
                    <p className="text-center text-gray-500/80 group-hover:text-white/60 w-3/4 mt-4">
                        At Easy Booking we are committed to helping you find the best value for your stay in this part of Europe. We constantly monitor prices across a wide range of hotels, from cozy guesthouses to luxurious resorts, to ensure you get the most competitive rates available.
